void Be12_pp_sim(Int_t nEvents = 20, TString mcEngine = "TGeant4")
{
  ...
  // Output file name
  TString outFile ="outputFiles/attpcsim_proto.root";

  // Parameter file name
  TString parFile="outputFiles/attpcpar_proto.root";
 ...
 // ------------------------------------------------------------------------
  ...
  FairPrimaryGenerator* primGen = new FairPrimaryGenerator();
	          ...
	          Double_t pz = 1.947/a;  // Z-Momentum / per nucleon!!!!!!
...
// ------------------------------------------------------------------------
  ...
  run->CreateGeometryFile("outputFiles/geofile_proto_full.root");
  // ------------------------------------------------------------------------
